...
- Add a VN reading mode with block and sentence screens, reveal speed controls, blank-area click advance, Sasayaki cue highlighting, overflow paging for oversized text blocks, and correctly sized cover/illustration image pages.
