...
- Rework reader lookup popups to render inside the reader WebView through an iframe layer, improving popup dismissal, touch stability, and large-result first paint while preserving recursive lookup, audio, Anki, redirect history, and Sasayaki controls.
