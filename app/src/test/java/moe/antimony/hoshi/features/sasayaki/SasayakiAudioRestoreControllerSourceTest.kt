...
class SasayakiAudioRestoreControllerSourceTest {
    ...
    fun audioRestoreControllerOwnsSourceResolutionEnginePrepareAndSessionCreation() {
        ...
        assertTrue(restore.contains("Media3SasayakiPlaybackEngine.prepare("))
        ...
        assertTrue(restore.contains("onPrepared = callbacks.onPrepared"))
        ...
        assertTrue(restore.contains("onError = callbacks.onError"))
        ...
        assertTrue(restore.contains("player = engine.media3Player"))
        ...
        assertTrue(restore.indexOf("Media3SasayakiPlaybackEngine.prepare(") < restore.indexOf("playbackLifecycle.attachEngine(engine)"))
